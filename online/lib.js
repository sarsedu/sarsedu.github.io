 ...
 var asd = 0;
        function change(){
            if (asd ==1){
             ...
             document.getElementById("aboutcad").innerHTML = "get knowledge in fun";
            document.getElementById("spec").src = "icon.png";
            document.getElementById("namefill").style.backgroundColor = "#5DB579";
           asd= 1 ;
